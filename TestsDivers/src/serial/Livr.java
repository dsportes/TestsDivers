...
public abstract class Livr extends Cell {
	...
	public abstract class Gac extends Noyau2 {
	...
	public abstract class Ac extends Noyau {
	...
	public abstract class Ap extends Noyau2 {
	...
	public abstract class Noyau2 extends Noyau1 {
		@HT(id = 40) public int cheque;
	...
	public abstract class Noyau1 extends Noyau {
	...
	public abstract class Noyau extends CellNode {
